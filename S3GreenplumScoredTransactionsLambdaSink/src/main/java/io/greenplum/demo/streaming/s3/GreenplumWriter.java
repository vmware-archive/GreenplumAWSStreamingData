...
public class GreenplumWriter {
    ...
    private String getDDL(String s3key) {
        ...
        sql.append("create external table ")
                ...
                .append(" estimated_prob_true double precision, ")
                .append(" fraud_flag boolean, ")
                .append(" account_id integer, ")
                .append(" merchant_state text, ")
                .append(" merchant_state_2 integer, ")
                .append(" estimated_prob_false double precision, ")
                .append(" a_transaction_delta double precision, ")
                .append(" merchant_long double precision, ")
                .append(" rlb_location_key text, ")
                .append(" m_fraud_cases integer, ")
                .append(" m_transaction_delta double precision, ")
    ...
    private String getDML(String s3key) {
        ...
        String tableName = getExternalTableName(s3key);
        dml.append("INSERT INTO credit_trans.stream_scored_transactions  (")
            .append(" transaction_id, transaction_date, account_number, merchant_city, merchant_city_alias,")
            .append(" transaction_amount, merchant_name, card_type, merchant_lat, location_id, ")
            .append(" estimated_prob_true, fraud_flag, account_id, merchant_state, merchant_state_2, ")
            .append(" estimated_prob_false, a_transaction_delta, merchant_long, rlb_location_key, ")
            .append(" m_fraud_cases, m_transaction_delta, posting_date ) ")
            .append(" SELECT ")
            .append(" transaction_id, transaction_date::timestamp without time zone, account_number, merchant_city,")
            .append(" merchant_city_alias, transaction_amount, merchant_name, card_type, merchant_lat, location_id, ")
            .append(" estimated_prob_true, fraud_flag, account_id, merchant_state, merchant_state_2, ")
            .append(" estimated_prob_false, a_transaction_delta, merchant_long, rlb_location_key, ")
            .append(" m_fraud_cases, m_transaction_delta, posting_date::timestamp without time zone ")
    ...
    /**
     * Ingest the new file of scored transactions in to Greenplum
     *
     * @param s3Key
     */
