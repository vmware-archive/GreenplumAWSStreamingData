 ...
 * @version 1.0
 *
 * This class handle S3 PUT event for a new file in configured bucket
 * and signal Greenplum to pull the data in. Any failures will be rolled back.
 * This lambda also configured with a Dead Letter Queue to handle failures
 */
